...
Scene* QuizThreeScene::createScene()
{
    auto scene = Scene::create();
    auto layer = QuizThreeScene::create();
...
bool QuizThreeScene::init()
{
    ...
    auto item1 = MenuItemFont::create("Menu", CC_CALLBACK_1(QuizThreeScene::doClose, this));
    ...
    auto item_1 = MenuItemImage::create("o.png", "o.png", "o.png", CC_CALLBACK_1(QuizThreeScene::doPushQuiz_o, this));
    auto item_2 = MenuItemImage::create("x.png", "x.png", "x.png", CC_CALLBACK_1(QuizThreeScene::doPushQuiz_x, this));
...
void QuizThreeScene::menuCallback(cocos2d::Ref* sender)
{
    CCLOG("menuCallback");
}

void QuizThreeScene::doPushQuiz_o(Ref* pSender)
{
    SimpleAudioEngine::getInstance()->playEffect("DropBread.wav"); // 클릭 효과음
    auto pScene = QuizThreeAnswerScene::createScene();
    Director::getInstance()->pushScene(pScene);
}

void QuizThreeScene::doPushQuiz_x(Ref* pSender)
{
    SimpleAudioEngine::getInstance()->playEffect("DropBread.wav"); // 클릭 효과음
...
void QuizThreeScene::doClose(Ref* pSender)
{
